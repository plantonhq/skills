...
7 kinds. Shared manifest grammar and the search grammar of every page:
...
| [Auth0User](auth0user/v1alpha1/reference.md) | Auth0UserSpec defines the configuration for an Auth0 User. | yes | yes |
